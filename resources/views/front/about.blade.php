...
@section('container')
	...
	<!-- Video -->
	<section class="section-video parallax100" style="background-image: url(./public/front_assets/images/header-menu-01.jpg);">
			...
			<div class="row p-t-170">
				<div class="col-md-6 p-b-30">
					<div class="wrap-pic-romantic size2 bo-rad-10 hov-img-zoom m-l-r-auto">
						<img src="{{asset('front_assets/images/our-story-02.jpg')}}" alt="IMG-OUR">
					</div>
				</div>
	...
	<!-- Banner -->
	<div class="parallax0 parallax100" style="background-image: url('{{asset('front_assets/images/bg-cover-video-02.jpg')}}');">
