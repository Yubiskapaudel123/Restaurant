...
<section class="bg-title-page flex-c-m p-t-160 p-b-80 p-l-15 p-r-15" style="background-image: url('{{asset('front_assets/images/332276075_504926338465734_8285107212269949982_n.jpg')}}');">
	...
	<section class="section-contact bg1-pattern p-t-90 p-b-113">
		...
		<div class="container">
			...
			<form method="POST" action="{{ route('contact.store') }}" class="wrap-form-reservation size22 m-l-r-auto">
				@csrf
				<div class="row">
					<div class="col-md-4">
						<!-- Name -->
					...
					<div class="col-md-4">
						...
						<div class="wrap-inputphone size12 bo2 bo-rad-10 m-t-3 m-b-23">
							<input class="bo-rad-10 sizefull txt10 p-l-20" type="number"  name="phone"   placeholder="Phone" value="{{old('phone')}}">
							@if ($errors->has('phone'))
					...
					<div class="col-12">
						...
						<textarea class="bo-rad-10 size35 bo2 txt10 p-l-20 p-t-15 m-b-10 m-t-3"  name="message" value="{{old('message')}}"></textarea>
			...
			<div class="row p-t-135">
				<div class="col-sm-8 col-md-4 col-lg-4 m-l-r-auto p-t-30">
					<div class="dis-flex m-l-23">
						<div class="p-r-40 p-t-6">
							<img src="{{asset('front_assets/images/icons/map-icon.png')}}" alt="IMG-ICON">
						</div>
				...
				<div class="col-sm-8 col-md-3 col-lg-4 m-l-r-auto p-t-30">
					<div class="dis-flex m-l-23">
						<div class="p-r-40 p-t-6">
							<img src="{{asset('front_assets/images/icons/phone-icon.png')}}" alt="IMG-ICON">
						</div>
				...
				<div class="col-sm-8 col-md-5 col-lg-4 m-l-r-auto p-t-30">
					<div class="dis-flex m-l-23">
						<div class="p-r-40 p-t-6">
							<img src="{{asset('front_assets/images/icons/clock-icon.png')}}" alt="IMG-ICON">
						</div>
						...
						<div class="flex-col-l">
							...
							<span class="txt23 size38">
								10:00 AM – 11:00 PM <br/>Every Day
							</span>
						</div>
					</div>
				</div>
