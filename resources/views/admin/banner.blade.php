            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="{{url('admin/banner')}}"><i class="fa fa-dashboard fa-fw"></i> Banner</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover">
                                ...
                                @endphp
                                    ...
                                    <tr>
                                        <td>{{ $serialNumber++}}</td>
                                        <td><img width="50px" src="{{asset('public/storage/media/banner/'.$banner->image)}}"></td>
                                       
                                        <td>
                                            <a href="{{url('admin/banner/manage_banner/')}}/{{$banner->id}}"><button type="button" class="btn btn-primary">Edit</button></a>
                                        </td>
                                        <td>
                                            @if($banner->status==1)
                                            
                                            <a href="{{url('admin/banner/status/0')}}/{{$banner->id}}"><button type="button" class="btn btn-success">Active</button></a>
