        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                   ...
                   <a href="reservation/manage_reservation"> 
                    <button type="button" class="btn btn-success">New Reservation</button>
                 </a>
                </div>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" >
                                ...
                                @foreach($data as $list)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('admin/reservation/manage_reservation/')}}/{{$list->id}}"><button type="button" class="btn btn-primary">Edit</button></a>
                                        </td>
                                        


                                        <td>
                                            <a href="{{url('admin/reservation/delete/')}}/{{$list->id}}"><button type="button" class="btn btn-danger">Delete</button></a>
                                        </td>
                                    </tr>
