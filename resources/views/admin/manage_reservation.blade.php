...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Manage Reservation</h1>
                   ...
                   {{session('message')}}
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form action="{{route('reservation.manage_reservation_process')}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            <label>Guest</label>
                                            <input type="number" class="form-control" name="guests" value="{{$guests}}">
                                          @error('guests')
                                          <div class="alert alert-danger">
                                               <strong>{{$message}}</strong>
                                           </div>
